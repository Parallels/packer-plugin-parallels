...
type FlatConfig struct {
	...
	ScreenConfigs             []common.FlatSingleScreenBootConfig `mapstructure:"screen_configs" required:"false" cty:"screen_configs" hcl:"screen_configs"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"screen_configs":               &hcldec.BlockListSpec{TypeName: "screen_configs", Nested: hcldec.ObjectSpec((*common.FlatSingleScreenBootConfig)(nil).HCL2Spec())},
